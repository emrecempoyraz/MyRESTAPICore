...
public class RequestPayLoadAsJsonArray {
    ...
    /* Test fail olduğunda daha fazla log detayı görebilmek için
     genel geçer specification yazdım.ResponseSpecification
     */
    ResponseSpecification customResponseSpecification;


    /*
     Content Type'ım setlenmediyse veya belli değilse encoder kullandım
     */
    @BeforeClass
