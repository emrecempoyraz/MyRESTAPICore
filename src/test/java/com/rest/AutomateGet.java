...
public class AutomateGet {
 ...
 //                       "workspaces.name", everyItem(startsWith("My"))
    ...
    public void extract_response(){
        Response res = given().
                baseUri("https://api.postman.com").
                header("X-Api-Key", "PMAK-608ba31d8128dc0037a27ae6-36627be455f7047777c4e3c6779b5902b6").
        when().
                get("/workspaces").
        then().
                assertThat().
    ...
    public void validate_status_code_Temp(){
        Response response = given().
                baseUri("https://api.postman.com").
                header("X-Api-Key", "PMAK-608ba31d8128dc0037a27ae6-38f84dc735a83c7103ebc44ef6241b8a29").
                when().
                get("/workspaces").
                then().
                log().all().
