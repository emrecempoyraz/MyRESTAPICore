...
public class ComplexPojoTest {
    ...
    public void beforeClass(){
        RequestSpecBuilder requestSpecBuilder = new RequestSpecBuilder().
                ...
                addHeader("X-Api-Key", "PMAK-608ba31d8128dc0037a27ae6-1f997085d02489047c945c8f94aec87d1b").
    ...
    public void complex_pojo_create_collection() throws JsonProcessingException, JSONException {
        ...
        then().spec(responseSpecification).
            extract().
                response().path("collection.uid"); // uid ile oluşan collectiona ulaştım
        ...
        // Bütün JSONBODY assert edilecekse bu yöntemi kullandım // JsonAssert-skyscreamer
        ...
        /*
        Request url string,Response url obje olduğu için karşılaştırmada hata aldım.
        Url karşılaştırabilmek için bu yöntemi kullandım
        */
